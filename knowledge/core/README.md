...
Este directorio contiene las **10 guías core** que definen el framework KODA:
...
| 3   | `guide_core_003_koda-hub-federation_koda.yml`  | `urn:knowledge:koda:core:hub-federation:1.0.0`    | Gestión de Knowledge Hub y Federación            |
...
| 9   | `guide_core_009_koda-tooling-spec_koda.yml`    | `urn:knowledge:koda:core:tooling:1.0.0`           | Especificación de KODA/Tooling para herramientas |
