...
|---|---------|-----|-----------|
| 000 | `guide_core_000_quickstart_koda.yml` | `urn:knowledge:gorenuble:core:quickstart:1.0.0` | **Guía de inicio rápido (EMPIEZA AQUÍ)** |
| 001 | `guide_core_001_koda-spec_koda.yml` | `urn:knowledge:gorenuble:core:koda-spec:1.1.0` | Especificación del formato KODA/Spec (RAÍZ) |
| 002 | `guide_core_002_koda-transform_koda.yml` | `urn:knowledge:gorenuble:core:koda-transform:1.0.0` | Metodología de transformación KODA/Spec |
| 003 | `guide_core_003_koda-hub-master_koda.yml` | `urn:knowledge:gorenuble:core:koda-hub-master:1.0.0` | Gestión KODA/Hub |
| 004 | `guide_core_004_koda-life-master_koda.yml` | `urn:knowledge:gorenuble:core:koda-life-master:1.0.0` | Gestión KODA/Life |
| 005 | `guide_core_005_koda-agent-spec_koda.yml` | `urn:knowledge:gorenuble:core:koda-agent-spec:1.0.0` | Especificación del protocolo KODA/Agent |
| 006 | `guide_core_006_koda-agent-construct_koda.yml` | `urn:knowledge:gorenuble:core:koda-agent-construct:1.0.0` | Metodología de construcción KODA/Agent |
| 007 | `guide_core_007_koda-test-spec_koda.yml` | `urn:knowledge:gorenuble:core:koda-test-spec:1.0.0` | Framework KODA/Test |
| 008 | `guide_core_008_schema-versioning_koda.yml` | `urn:knowledge:gorenuble:core:schema-versioning:1.0.0` | Política de versionado de schemas |
...
2. Sigue `koda-hub-master` para estructura de directorios y federación
